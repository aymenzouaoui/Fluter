...
class _HomeDrawerState extends State<HomeDrawer> {
                        ...
                        child: RotationTransition(
                          ...
                          child: Container(
                            ...
                            child: ClipRRect(
                              ...
                              child:
                                  Image.network(userImage), // Updated this line
                            ),
                          ),
                        ),
                      );
  ...
  try {
    ...
    final Map<String, dynamic> response = await AuthService().logoutUser(authToken);
    print(response);

    // Optionally, you can navigate to the login screen or perform other actions
    // For example, you can pop the current screen to close the drawer
    Navigator.of(context).pop();
    // Navigate to the login screen or other destination
